...
const SUPABASE_URL = 'https://vuklrohqbeiwzgyykarf.supabase.co';
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ1a2xyb2hxYmVpd3pneXlrYXJmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDYxNjc0MTksImV4cCI6MjAyMTc0MzQxOX0.MOYHVy2UqPFwIhuk0F3F1SGUGfPaXFgDPgLZZyAJ9RU';
...
export class UsersService {
  ...
  constructor() {
    this.supaClient = createClient(SUPABASE_URL, SUPABASE_KEY);
  }
